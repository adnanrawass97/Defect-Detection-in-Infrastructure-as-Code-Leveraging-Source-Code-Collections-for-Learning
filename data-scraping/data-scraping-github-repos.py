...
# Accessing GitHub Personal Access Token from environment variable
...
def process_diff(diff_text):
    try:
        ...
        # Spliting the patch text into hunks
        ...
        for hunk in hunks:
            ...
            for line in lines:
                ...
                if line.startswith('!'):
                    continue
                # Checking if the line starts with '-'  deleted line
                elif line.lstrip().startswith('-'):
                    # Appending the deleted line to the deleted_lines list
                    deleted_lines.append(line.lstrip()[1:].rstrip('\r'))
                # Checking if the line starts with '+' indicating an added line
                elif line.lstrip().startswith('+'):
                    # Appending the added line to the added_lines list
...
def main():
    ...
    # Reading repository, commit IDs, and file paths from CSV
